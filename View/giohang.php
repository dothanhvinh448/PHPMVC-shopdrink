...
if(!isset($_SESSION['cart'])||count($_SESSION['cart'])==0):
 ...
 include "home.php";
  ...
  ?>
    <form action="trangchu.php?action=giohang&act=update_cart" method="post">
      <table class="table table-bordered">
        ...
        ?>
            <tr>  
              ...
              <td>
                <a href="trangchu.php?action=giohang&act=emty_cart&id=<?php echo $item['mahh'] ?>"><button type="button" class="btn btn-warning">Xóa khỏi Cart</button></a>
        ...
        ?>
          <tr>
            ...
            <td><a href="trangchu.php?action=order&act=order_detail">Thanh Toán Ngay</a></td>
          </tr>
        </tbody>
      </table>
    </form>

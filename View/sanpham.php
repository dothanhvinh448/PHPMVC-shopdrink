  ...
  <section id="examples" class="text-center">
      <div class="row">
          <div class="col-lg-8 text-right">
             ...
             if($ac==1)
             {
                 echo ' <marquee style="color:red">
                 <h3 class="mau">Đồ Uống | Sinh Tố Ngon ,Bổ ,Rẻ  </h3>
             </marquee><br />';
             }
             elseif($ac==2)
             {
      ...
      <div class="row">
         ...
         ?>
              <div class="col-lg-3 col-md-4 mb-3 text-left">
                  ...
                  <a href="trangchu.php?action=home&act=detail&id=<?php echo $set['mahh'];?>">
                      <span><?php echo $set['tenhh'].'-'.$set['tuyvi'];?></span></br></a>
                  <button class="btn btn-info" id="may4" value="lap 4">drink</button>
                  <button class="btn btn-warning" >
                      <a href="trangchu.php?action=home&act=detail&id=<?php echo $set['mahh'];?>" style="color:red">Order Ngay</a></button>
